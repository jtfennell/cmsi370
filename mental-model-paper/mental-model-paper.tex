...
\end{abstract}
% JD: Three really easy typos just in the abstract...this does not make for a good
%     first impression.  (I fixed them---compare with the prior version in GitHub
...
% JD: The only time to quote directly is when the particular word choice or turn
%     of phrase is so compelling that changing any words detracts from the information
%     being conveyed.  All other times, just paraphrase.
%
%     I don't think those quotes above carry anything special in their wording.  Thus,
%     you are better off just restating them in your own words.  Makes the text flow
%     better because it retains the same voice---yours.
...
% JD: Whew!  This part has some nice references covering interesting work, but
%     dang it's peppered with little misspellings and glitches.  That's really
%     distracting, and does not send a good signal about the "QA" that went
%     into this paper.
...
% JD: You should cite those guidelines documents.
...
% JD: Nice gathering of observations here, in each paragraph of these two sections.
